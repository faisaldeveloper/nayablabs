...
$place_of_issue = $res_patient['place_of_issue'];
$date_of_issue = $res_patient['date_of_issue'];
if(!empty($date_of_issue) && $date_of_issue!='0000-00-00'){
$place_date_of_issue = $place_of_issue." - ".date("d/m/Y", strtotime($date_of_issue));
}
else $place_date_of_issue = "-";
...
foreach($array as $key => $val){ 	
	$pos1 = stripos($key, 'X-RAY');	
 	if ($pos1 === false){  }
	else { $remarks = PatientTestDetail::model()->find("test_summary_id = $test_summary_id AND test_id = 16")->remarks;  break; } 
  } 	
...
$reg_no_barcode =  str_pad($reg_no, 5, '0', STR_PAD_LEFT);
$barcode = file_get_contents("http://localhost/barcode2/html/code39.php?code=".$reg_no_barcode);
 ?>
...
<?php /*?><?php echo CHtml::link('<img src="/nayablab/images/pdf-but.png">', array('PatientTestSummary/pdf','id'=>$test_summary_id),array('target'=>'_blank')); ?> <?php */?>
...
<p>
<span>Name</span> <span id="cat4"><b>&nbsp;<?php echo strtoupper($name); ?></b></span><span>S/O</span> <span id="cat5"><b>&nbsp;<?php echo strtoupper($father_name); ?></b></span> </p>
...
<p><span>Address:</span> <span id="cat10"><b>&nbsp;<?php echo ucwords(strtolower($address)); ?></b></span> <span>Visa Type:</span> <span id="cat11"><b>&nbsp;<?php echo $visa_type; ?></b></span></p>
...
<!--  row 1  -->
<tr class="tableheadings firstrow"><td>TYPE OF EXAMINATION</td><td>RESULT</td></tr>
<!--  row 2  -->
...
<tr style="height:22px;"><td><?php $rt = 'Rt-EarHearing'; echo ucwords(strtolower($ar->$rt)); ?></td></tr>
<tr style="height:22px;"><td><?php $lt = 'Lt-EarHearing'; echo ucwords(strtolower($ar->$lt)); ?></td></tr>
...
<tr style="height:20px;"><td>Arm / Hands (Right / Left)</td></tr>
...
<tr style="height:20px;"><td><?php echo ucwords(strtolower($ar->ArmsHandsRtLt)); ?></td></tr>
...
<tr ><td><?php echo strtoupper(strtolower($ar->RespiratoryLungs)); ?></td></tr>
<tr ><td><?php echo strtoupper(strtolower($ar->Abdomen)); ?></td></tr>
<tr ><td><?php echo strtoupper(strtolower($ar->CNSMentalillness)); ?></td></tr>


</table></td></tr>
<!--  row 10  -->
<tr class="tableheadings headingrows2"><td>CHEST X-RAY PA view</td><td><?php $xray = 'ChestX-RAYPAview'; echo ucwords(strtolower($ar->$xray)); ?></td></tr>
<!--  row 11  -->
...
<tr ><td><b>Blood Groop:</b></td></tr>
<tr ><td>ABO</td></tr>
<tr ><td>Rh factor</td></tr>
<tr ><td><b>Cholesterol</b></td></tr>
<tr ><td><b>Liver Function Test</b></td></tr>
<tr ><td>Serum GPT</td></tr>
<tr ><td>Serum GOT</td></tr>
<tr style="height:30px" ><td><b>VDRL/TPHA</b></td></tr>
</table></td>
...
<tr style="height:30px" ><td><?php echo ucwords(strtolower($ar->VDRLTPHA)); ?></td></tr>
</table></td></tr>
...
<tr style="height:22px;"><td>Hepatitis C Virus (Anti HCV)</td></tr>
</table></td>
...
<!--  row 9  -->
<tr style="height:28px;"><td>HIV/AIDS Antibody I/II</td><td><?php echo ucwords(strtolower($ar->HIVAIDSAntibodyIII)); ?></td></tr>
</table>
</div>
...
<table width="100%">
<tr>
<td><div style=" float:left; margin-left:1px; width:266px; height:107px; font-family:'Arial'; font-size:9pt">
<B>Remarks:</B><br />
...
<B>*This Medical report is valid only for 03 Month</B>
</div><!-- close div!-->

</td>
<td>
<div style="font:right; width:370px; height:61px;">
<span class="textstyle"> Medical Officer's Signature</span> <span id="cat20"><b></b></span>

<span class="textstyle"> Medical Officer's Name:</span> <span id="cat21"><b><?php echo $physician_name; ?> (M.B.B.S)</b></span>
