<?php /* Smarty version 2.6.26, created on 2014-01-07 11:16:50
...
<?php if ($this->_tpl_vars['SHOW_EXPANDED']): ?>
 ...
 :<br>
                             <input  type="text" style="width: 50%" name="expand_value" value="<?php echo $this->_tpl_vars['EXPANDED_SEARCH_VALUE']; ?>
">
									<input id="reporticoPerformExpand" class="swPrpSubmit" type="button" name="EXPANDSEARCH_<?php echo $this->_tpl_vars['EXPANDED_ITEM']; ?>
" value="<?php echo $this->_tpl_vars['T_SEARCH']; ?>
"><br>
<?php echo $this->_tpl_vars['CONTENT']; ?>

							<br>
							<input class="swPrpSubmit" type="button" id="reporticoPerformExpand" name="EXPANDCLEAR_<?php echo $this->_tpl_vars['EXPANDED_ITEM']; ?>
" value="<?php echo $this->_tpl_vars['T_CLEAR']; ?>
">
							<input class="swPrpSubmit" type="button" id="reporticoPerformExpand" name="EXPANDSELECTALL_<?php echo $this->_tpl_vars['EXPANDED_ITEM']; ?>
" value="<?php echo $this->_tpl_vars['T_SELECTALL']; ?>
">
							<input class="swPrpSubmit" type="button" id="returnFromExpand" name="EXPANDOK_<?php echo $this->_tpl_vars['EXPANDED_ITEM']; ?>
