<?php /* Smarty version 2.6.26, created on 2014-01-07 11:08:55
...
<?php if ($this->_tpl_vars['SHOW_LOGOUT']): ?>
			<TD width="15%" align="right" class="swPrpTopMenuCell">
				<input class="swPrpSubmit reporticoSubmit" type="submit" name="adminlogout" value="<?php echo $this->_tpl_vars['T_LOGOFF']; ?>
">
			</TD>
<?php endif; ?>
...
<?php echo $this->_tpl_vars['T_ADMIN_INSTRUCTIONS']; ?>
				...
				<input class="swPrpSubmit reporticoSubmit" type="submit" name="login" value="<?php echo $this->_tpl_vars['T_LOGIN']; ?>
">
...
<br>
				<br>
				<input class="swPrpSubmit reporticoSubmit" type="submit" name="submit_admin_password" value="<?php echo $this->_tpl_vars['T_SET_ADMIN_PASSWORD']; ?>
">
				<br>
...
<?php endfor; endif; ?>
				...
				<input class="swMntButton reporticoSubmit" type="submit" name="submit_menu_project" value="<?php echo $this->_tpl_vars['T_GO']; ?>
">
			</TD>
		</TR>
<?php endif; ?>
...
<?php endfor; endif; ?>
				...
				<input class="swMntButton reporticoSubmit" type="submit" name="submit_design_project" value="<?php echo $this->_tpl_vars['T_GO']; ?>
">
			</TD>
		</TR>
		<TR> 
...
<?php endfor; endif; ?>
				...
				<input class="swMntButton reporticoSubmit" type="submit" name="submit_configure_project" value="<?php echo $this->_tpl_vars['T_GO']; ?>
">
			</TD>
		</TR>
		<TR> 
...
<?php endfor; endif; ?>
				...
				<input class="swMntButton reporticoSubmit" type="submit" name="submit_delete_project" value="<?php echo $this->_tpl_vars['T_GO']; ?>
">
			</TD>
		</TR>
<?php endif; ?>
