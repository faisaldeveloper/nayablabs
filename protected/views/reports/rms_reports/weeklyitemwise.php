...
?>
<h1>Weekly Item Wise Report (Week # <?php echo $weekno;?> of 20<?php echo $yearno;?>)</h1>
<style>
.totalsclass{
	text-align:right;
}
...
$previous_link=Yii::app()->baseUrl.'/reports/weeklyitemwise/'.$linkparam_pre;
...
$next_link =Yii::app()->baseUrl.'/reports/weeklyitemwise/'.$linkparam_next;
...
$resultset  =  Yii::app()->db->createCommand("Select * FROM `tableorder` WHERE weekno=$weekno and date_of_tableorder like '20".$yearno."-%'")->queryAll();
   ...
   cols++;
	...
	//griddates = [['Year', 'Sales', 'Profit'],['2004',  82494.5,	8494.5],['2005',  9259,      9240]];
      ...
      function drawChart() {
        ...
        var options = {
           title: 'Weekly Item Wise Report Graph (Week # <?php echo $weekno;?> of 20<?php echo $yearno;?>)',
   ...
   //add item to array
	...
	$('#mychart_div').css('height',rows+'px');
        $('#mychart_div').highcharts({
            ...
            title: {
                text: 'Weekly Item Wise Report Graph (Week # <?php echo $weekno;?> of 20<?php echo $yearno;?>)'
            },
            subtitle: {
