...
?>
<h1>Yearly Item Wise Report(<?php echo $MY;?>)</h1>
<style>
.totalsclass{
	text-align:right;
}
...
$resultset  =  Yii::app()->db->createCommand("Select * FROM `tableorder` WHERE date_of_tableorder like '".$MY."-%'")->queryAll();
   ...
   cols++;
	...
	//griddates = [['Year', 'Sales', 'Profit'],['2004',  82494.5,	8494.5],['2005',  9259,      9240]];
      ...
      function drawChart() {
        ...
        var options = {
           title: 'Yearly Item Wise Report Graph (20<?php echo $yearno;?>)',
   ...
   //add item to array
	...
	$('#mychart_div').css('height',rows+'px');
        $('#mychart_div').highcharts({
            ...
            title: {
                text: 'Yearly Item Wise Report Graph (20<?php echo $yearno;?>)'
            },
            subtitle: {
