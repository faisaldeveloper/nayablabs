...
<div id="left-logo">
<div class="logo">
<?php echo '<img src="images/Untitled-1.jpg" alt="logo1" class="imgbrder" width="100%" />'; ?>
</div>
<div class="logo2">
<?php /*?><img src="<?php echo Yii::app()->baseUrl; ?>/images/nayab-logo.png" alt="photo2" /><?php */?>
<?php echo '<img src="images/nayab-logo.png" alt="logo2" class="imgbrder" width="100%" />'; ?>
...
<?php if(!empty($photo_file_name22)){
echo '<img src="'.Yii::app()->baseUrl.'"/patient_photos/"'.$photo_file_name.'" alt="logo3" class="imgbrder" width="100%" />';
 }?>
</div>
...
<?php echo $str; ?>
<!--<ul>  
<li>fkjdalflkf jadsk klfjasdlfj</li>
<li>fdkj fjkd fkldjfk jfksd jkfad jksjdf jfksd fjdaslk fjlkfjslk jklsjdfl adsjflaskjf 
fsdkjfkls djlkfjdsa kfj jklfjasdl fjhlkjlka sdfj jfkdsj f</li>
</ul>-->
...
<tr style="height:30px" ><td>VDRL/TPHA</td></tr>
</table></td>
...
<table width="100%">
<tr>
<td><div style=" float:left; margin-left:1px; width:266px; height:107px; font-size:9pt">
<B>Remarks:</B><br />
<b>He</b> &emsp; is &emsp; <span id="cat19"><b><?php echo $remarks; ?></b></span> For the job.


</div><!-- close div!-->
<div style=" float:left; margin-left:1px; width:266px; height:18px; font-size:8pt; margin-top:5px;">
