...
'items'=>array(
array('label'=>Yii::t('layout','Designations'), 'url'=>array('/HrDesignation/admin')),
array('label'=>Yii::t('layout','Leaves Types'), 'url'=>array('/HrLeavesTypes/admin')),
array('label'=>Yii::t('layout','Employees'), 'url'=>array('/Hremployee/admin')),
array('label'=>Yii::t('layout','Employee Leaves'), 'url'=>array('/HrEmployeeLeaves/admin')),
array('label'=>Yii::t('layout','Employee Attendance'), 'url'=>array('/HrAttendance/admin')),
...
//array('label'=>Yii::t('layout','POS'), 'url'=>array('/Category/admin')),
),
