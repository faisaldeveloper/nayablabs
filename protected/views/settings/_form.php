...
?>
	...
	<div class="row">
		...
		$options['html_options']['onchange']="$('#Settings_text').val($(this).find('option:selected').text())";
		...
		$options['html_options']['onchange']="$('#Settings_text').val($(this).val())";
		echo $form->textField($model,'value',$options['html_options']);
		}
		
		?>
        <?php echo $form->hiddenField($model,'text',array('size'=>50,'maxlength'=>100)); ?>
