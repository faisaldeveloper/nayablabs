...
<input type="hidden" id="discountrate" name="discountrate" value="<?php echo $discountrate;?>" style="width:15px" />
        ...
        <div style="width:395px; height:22px; overflow:hidden;">
        <div>
          ...
          <div id="tables_div" style="background: none repeat scroll 0 0 #ccc;clear: left;height: 26px;margin: 0;padding: 0 5px;width: 389px; overflow-y:scroll" 
          ...
          <div id="screen_div" style="background: none repeat scroll 0 0 #0f0;clear: left;height: 46px;margin: 0;padding: 0 5px;width: 389px;">
      ...
      <div class="order_status" style="height:auto">
      	<div id="bill_header">
        <div class="order_heading order_frist" style="width:40px"> S# </div>
        <div class="order_heading order_second" style="width:175px">Description </div>
        <div class="order_heading order_third" style="width:40px"> Qty</div>
        <div class="order_heading order_fourth" style="width:55px"> Rate </div>
        <div class="order_heading order_fifth" style="width:85px"> Total </div>
      	</div>
     </div>
