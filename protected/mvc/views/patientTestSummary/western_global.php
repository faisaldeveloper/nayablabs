...
<span>Chest X-Ray:-  &emsp;</span><span id="cat8"><?php echo ucwords(strtolower($ar->ChestX-RAY));	 ?></span>
...
<div id="test1">4. Blood Group</div> <div id="result1">&emsp;<?php echo ucwords(strtolower($ar->BloodGroup)); ?></div>
...
<div class="ray">
Vaccination  &emsp; &emsp;&emsp;<span id="cat8"><?php echo ucwords(strtolower($ar->Vacination)); ?></span><br />
