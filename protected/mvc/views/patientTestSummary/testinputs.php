...
<div class="container_mce">
  ...
  <tr>
   ...
   <td>&nbsp;Design / Ref No:</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;Panel:</td>
    <td>&nbsp;<?php echo "Medical Examination"; ?></td>   
  </tr>
</table>
...
<h5>Medical Examination</h5>
	 <table align="center" width="100%" border="0">
		...
		?>
  		<tr id="tr_input">
    		<td width="37%">&nbsp;<?php echo $row['name'] ?></td>
    		<td width="63%">&nbsp;<?php echo $form->textFieldRow($model,'measured_reading[]',array('value'=>$val, 'class'=>'span2','maxlength'=>50, 'labelOptions' => array("label" => false))); ?>	</td>  
 		</tr>
        <?php }?>
</table>
