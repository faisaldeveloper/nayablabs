...
array(
			...
			'header' => CHtml::link(CHtml::image(Yii::app()->baseUrl.'/images/glyphicons/glyphicons/png/glyphicons_432_plus.png', Yii::t('strings','Create').' '.Yii::t('strings','Submenu'),array('title'=>Yii::t('strings','Create').' '.Yii::t('strings','Submenu') )),array('submenu/create'),array('class'=>'update-dialog-create','id'=>Yii::t('strings','Create').' '.Yii::t('strings','Submenu'))),
